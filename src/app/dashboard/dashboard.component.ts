...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
     ...
     const optionsDailySalesChart: any = {
          ...
          low: 0,
          high: 50, // Sensor Sus: we recommend you to set the high sa the biggest value + something for a better look
     ...
     const optionsCompletedTasksChart: any = {
          ...
          low: 0,
          high: 1000, // Sensor Sus: we recommend you to set the high sa the biggest value + something for a better look
          chartPadding: { top: 0, right: 0, bottom: 0, left: 0}
      }
